...
//		try {
//			Stream<Path> currentFolderPathsStream = Files.list(Paths.get(currentPathString));
//			currentFolderFiles = (int) currentFolderPathsStream.count();
//			currentFolderPathsStream.close();
//
...
//		
//		Path filePath = Paths.get(currentPathString + File.separator + picture.getRnd_name() + "." + picture.getExt());
//		try {
...
//
//		Path path = Paths.get(rootDirectory + currentFolderInt + File.separator + picture.getRnd_name() + "." + picture.getExt());
//		try {
...
//	}
//
//	private void manageFolder() throws StorageException {
//		currentPathString = rootDirectory + folderPrefix + currentFolderInt;
//		Path folderPath = Paths.get(currentPathString);
//		try (Stream<Path> currentFolderPathsStream = Files.list(folderPath);) {
//			currentFolderFiles = (int) currentFolderPathsStream.count();
//
//			if (currentFolderFiles > maxFiles) {
//				
...
//
//		} catch (IOException e) {
//			throw new StorageException("Failed to create folder " + currentPathString, e);
//		}
//
//	}
//
